...
| **ML aplicado** | Pipeline de clasificación con métricas de validación (Macro-F1) en un caso real (Periscope) — proyecto puntual, no área de especialización. |
...
**[Ver las 11 decisiones completas →](DECISIONES.md)**
